      ...
      <div class="aspect-ratio-box-inner">
        ...
        >
          ...
          <div class="contenedor">
            ...
            <div class="fila">
              <p class="pequeña columna-1 text-right">Fecha recogida:</p>
              <p class="columna grande-light">
                {{ reservation.pickup_date }}
              </p>
            </div>
            <div class="fila">
              <p class="pequeña columna-1 text-right">Hora recogida:</p>
              <p class="columna grande-light">
                {{ reservation.pickup_hour }}
              </p>
            </div>
            <div class="fila">
              <p class="pequeña columna-1 text-right">Lugar recogida:</p>
              <p class="columna grande-light">
                {{ reservation.pickup_city }}
              </p>
            </div>
            <div class="fila">
              <p class="pequeña columna-1"></p>
              <div class="columna">
                <p class="pequeña">
          ...
          <div class="contenedor" style="margin-top: 5%">
            <!-- Detalles de Retorno -->
            <div class="fila">
              <p class="pequeña columna-1 text-right">Fecha retorno:</p>
              <p class="columna grande-light">
                {{ reservation.return_date }}
              </p>
            </div>
            <div class="fila">
              <p class="pequeña columna-1 text-right">Hora retorno:</p>
              <p class="columna grande-light">
                {{ reservation.return_hour }}
              </p>
            </div>
            <div class="fila">
              <p class="pequeña columna-1 text-right">Lugar retorno:</p>
              <p class="columna grande-light">
                {{ reservation.return_city }}
              </p>
            </div>
            <div class="fila">
              <p class="pequeña columna-1 text-right"></p>
