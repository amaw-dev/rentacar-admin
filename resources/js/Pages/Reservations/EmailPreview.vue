            ...
            <div class="aspect-ratio-box-inner">
                ...
                >
                    ...
                    <div style="margin-top: 12%">
                        <p class="mediana-light text-center">
                            Código de Reserva
                        </p>
                    ...
                    <div class="contenedor">
                        ...
                        <div class="fila">
                            <p class="pequeña columna text-right">
                                Fecha recogida:
                            </p>
                ...
                <div class="container-white">
                    ...
                    >
                        ...
                        <!-- <div class="fila" style="margin-bottom: 1%">
                            ...
                            <p class="pequeña text-right columna">250.001</p>
                        </div> -->
                        <!-- <div class="fila" style="margin-bottom: 1%">
                            <p class="pequeña columna">Descuento 39%:</p>
                            <p class="pequeña text-right columna">151.261</p>
                        </div> -->
                        <div
                            v-if="reservation.extra_hours"
                            class="fila"
                        ...
                        <div class="fila" style="margin-bottom: 1%">
                            <p class="pequeña columna">
                                Total por ({{ reservation.selected_days }})
                                días:
                            </p>
                            <p class="pequeña text-right columna">
                ...
                <div class="container-white">
                    ...
                    >
                        <p class="pequeña text-justify">
                            Los descuentos adquiridos en esta reserva son
                            Intransferibles.
                        </p>
                        <br />
                        <p class="pequeña text-justify">
                            Solicitar cambios puede afectar los descuentos
                            adquiridos, verifique que la Información sea
                            correcta o de lo contrario solicite cuanto antes una
                            nueva reserva.
                        </p>
                        <br />
                        <p class="pequeña text-justify">
                            Evite perder la reserva presentandose en el lugar de
                            Recogida 30 minutos antes de la hora programada con
                        ...
                        <p class="pequeña-pequeña text-justify">
                            Para nacidos en Colombia se requiere licencia
                            colombiana o permiso temporal, no se aceptan
