        ...
        <div class="aspect-ratio-box-inner">
            ...
            <div class="d-flex-custom gap-custom-1 content-center">
                <div class="">
                    <img
                        class="img-fluid"
                        width="230"
                        src="{{ asset("storage/carro.png")}}"
                        alt="carro"
                    />
                </div>
                <div>
                    <p class="grande-light">GAMA C</p>

                    <p class="grande-light">Economico Mecanico</p>
            ...
            >
                ...
                >
                    ...
                    <p class="d-custom-inline mediana-light top-custom-1rem">
                        Hora:
                    </p>
                    <p class="d-custom-inline mediana-light top-custom-1rem">
                        Lugar:
                ...
                <div class="d-flex-custom" style="flex-direction: column">
                    <p class="d-custom-inline grande font-blue">13 JUN 2024</p>
                    <p class="d-custom-inline grande font-blue">4:00pm</p>
                    <p class="d-custom-inline grande font-blue">Medellin</p>
                    <p
                        class="d-custom-inline font-blue mediana-light"
                        style="margin-bottom: 2rem"
                    >
                        <strong
                            >Aeropuerto Jose Maria C. <br />Agencia
                            <img
                                class="img-fluid"
                                width="100"
                                src="{{ asset("storage/Localiza.png") }}"
                                alt="logaliza"
                            />
                        </strong>
                    </p>
            ...
            >
                ...
                >
                    ...
                    <p class="grande-light">
                        Diego Alexander Melo <br />C.C 1111111111
                    </p>
                </div>
            </div>
        ...
        <div class="aspect-ratio-box-inner background-blue-custom">
            <div style="padding: 3rem 4rem">
                ...
                <p class="grande-light text-justify">
                    Deberia presentarse en el lugar de recogida 30 minutos antes
                    o maximo 30 minutos despues de la fecha y hora programada.
                </p>
                <br />
                <p class="grande-light text-justify">
                ...
                <p class="grande-light">
                    1) Tarjeta de credito fisica <br />
                    2) Licencia de conducción vigente <br />
                    3) Cedula o pasaporte <br />
                </p>
                ...
                >
                    ...
                    <div class="d-flex-custom" style="flex-direction: column">
                        <p class="d-custom-inline grande">13 JUN 2024</p>
                        <p class="d-custom-inline grande">4:00pm</p>
                        <p class="d-custom-inline grande">Medellin</p>
                        <p
                            class="d-custom-inline mediana-light"
                            style="margin-bottom: 2rem"
                        >
                            <strong>Aeropuerto Jose Maria C. </strong>
                        </p>
                    </div>
                </div>
            </div>
    ...
    <script>
        function adjustFontSize() {
            ...
            const config1 = [
                ...
                { class: ".mediana", minFontSize: 13, maxFontSize: 30, divisor: 22 },
                {
                    class: ".mediana-light",
                    minFontSize: 13,
                    maxFontSize: 26,
                ...
                { class: ".pequeña", minFontSize: 12, maxFontSize: 22, divisor: 30 },
                {
                    class: ".pequeña-light",
                    minFontSize: 13,
                    maxFontSize: 22,
            ...
            const config2 = [
                ...
                { class: ".mediana", minFontSize: 15, maxFontSize: 32, divisor: 20 },
                {
                    class: ".mediana-light",
                    minFontSize: 13,
                    maxFontSize: 24,
                ...
                { class: ".pequeña", minFontSize: 14, maxFontSize: 24, divisor: 28 },
                {
                    class: ".pequeña-light",
                    minFontSize: 14,
                    maxFontSize: 24,
