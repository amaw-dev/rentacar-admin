...
class SendLocalizaTotalInsuranceReservationNotificationJob implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        if(!is_null($franchise)){
            try {
                ...
                Log::info("An total insurance reservation email notification was send to localiza board", $this->reservation->toArray());
            } catch (\Throwable $th) {
