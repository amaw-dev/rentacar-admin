...
class ReservationResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'phone'  =>  $this->phone,
            'email'  =>  $this->email,
            'category'  =>  $this->short_formatted_category,
            ...
            'extra_driver'  => (bool)  $this->extra_driver,
            ...
            'status'  =>  $this->status,
            'created_at'  =>  $this->short_formatted_created_at,
            'updated_at'  =>  $this->short_formatted_updated_at,
